  ...
  return (
    <div className="relative w-full">
      ...
      {currentIndex > 0 && (
        <button
          onClick={scrollPrev}
          className="bg-background/70 absolute top-1/2 left-0 -translate-y-1/2 rounded-full border p-1"
        >
          <ChevronLeft />
        </button>
      )}
      ...
      {currentIndex < scrollSnapCount - 1 && (
        <button
          onClick={scrollNext}
          className="bg-background/70 absolute top-1/2 right-0 -translate-y-1/2 rounded-full border p-1"
        >
          <ChevronRight />
        </button>
      )}
